...
const SAMPLE_TOOLS = [
  ...
  },
  {
    ...
    description: 'Gemini is Google\'s meest geavanceerde AI model, met multimodale capaciteiten voor tekst, code, afbeeldingen en video.',
  ...
  },
  {
    ...
    description: 'Windsurf is Codeium\'s AI IDE met diepe codebase kennis en automatische refactoring mogelijkheden.',
  ...
  // Terminal Tools
  {
    ...
    description: 'Claude Code is de officiële command-line interface voor Claude, ideaal voor terminal-gebaseerde workflows en automatisering.',
  ...
  // LLM Providers
  {
    ...
    description: 'Anthropic is het AI-bedrijf achter Claude, met focus op veilige en behulpzame AI-systemen.',
  ...
  },
  {
    ...
    description: 'OpenAI is de maker van GPT-4 en ChatGPT, een van de meest invloedrijke AI-bedrijven ter wereld.',
  ...
  },
  {
    ...
    description: 'Google AI biedt Gemini modellen en Vertex AI platform voor enterprise AI-oplossingen.',
  ...
  // AI Studios
  {
    ...
    description: 'Runway is een toonaangevend platform voor AI-video generatie met Gen-3 Alpha model.',
  ...
  },
  {
    ...
    description: 'Pika maakt het eenvoudig om video\'s te genereren en te bewerken met AI, van tekst of afbeelding naar video.',
  ...
  // Automation
  {
    ...
    description: 'n8n is een open-source automatiseringsplatform waarmee je visueel workflows bouwt tussen honderden apps.',
  ...
  },
  {
    ...
    description: 'Zapier verbindt 6000+ apps om workflows te automatiseren zonder een regel code te schrijven.',
  ...
  },
  {
    ...
    description: 'Make (voorheen Integromat) biedt krachtige visuele automatisering met geavanceerde scenario bouwmogelijkheden.',
