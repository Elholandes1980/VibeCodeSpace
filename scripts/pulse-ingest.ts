 ...
 *
 * Automated content ingestion for Pulse feature.
 * Fetches from RSS feeds, processes with Claude AI, stores in Payload.
 * Designed to run as Vercel Cron job or manually.
 *
 * Run manually: npx tsx scripts/pulse-ingest.ts
 * Environment: ANTHROPIC_API_KEY, DATABASE_URL required
 *
 * Related:
...
import { analyzePulseItem } from '../lib/services/pulse-ai'
import type { PulseItemInput } from '../lib/services/pulse-ai'
